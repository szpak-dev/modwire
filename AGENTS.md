...
- Put all caches, diagnostic dumps and local build/verification outputs under gitignored `.dev/`. Configure tools accordingly; keep source, configuration and deliberate verification summaries tracked.
